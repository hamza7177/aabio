import 'package:corrier/modules/corrier/reservations/view/reservation_detail_screen.dart';
...
class OngoingReservation extends StatefulWidget {
  OngoingReservation({super.key});

  @override
  State<OngoingReservation> createState() => _OngoingReservationState();
}

class _OngoingReservationState extends State<OngoingReservation> {
          ...
          Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text('Accept or Decline', style: AppTextStyle.mediumBlack16),
                  Text('select reservation', style: AppTextStyle.regularGrey12),
                ],
              ),
              Container(
